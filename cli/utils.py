    ...
    _CATEGORIES: Dict[str, Dict[str, str]] = {
        ...
        "social_sentiment": {
            ...
            "options": {
                ...
                "reddit": "Reddit only",
                "chinese": "Chinese A-share (East Money 千股千评 + detail scores, via AKShare)",
                "em_detail_scores": "East Money detail scores only (历史评分 + 机构参与度)",
                "em_comment": "East Money 千股千评 only (综合评分)",
                "guba_posts": "East Money Guba posts (东方财富股吧 帖子, scraping)",
                "xueqiu_posts": "Xueqiu posts (雪球 个股讨论, may be rate-limited)",
            },
            "default": "all",
        },
    }
